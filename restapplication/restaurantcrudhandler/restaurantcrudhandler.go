...
import (
	...
	// restauranterrors "mongorestaurantsample-master/restapplication/packages/errors"
	...
	//	"gohttpexamples-master/sample4/dbrepo/dbrepository"
	"mongorestaurantsample-master/restapplication/packages/httphandlers"
	mthdroutr "mongorestaurantsample-master/restapplication/packages/mthdrouter"
	"mongorestaurantsample-master/restapplication/packages/resputl"
	restauranterrors "mongorestaurantsample-master2/restapplication/packages/errors"
)
...
func (p *RestaurantCrudHandler) Get(r *http.Request) resputl.SrvcRes {
	...
	queryParams, ok := r.URL.Query()["type_of_food"]
...
func (p *RestaurantCrudHandler) Post(r *http.Request) resputl.SrvcRes {
	...
	userObj := f.NewUser(requestdata.Name, requestdata.Address, requestdata.AddressLine2, requestdata.URL, requestdata.Outcode, requestdata.Postcode, requestdata.Rating, requestdata.TypeOfFood)
...
func (p *RestaurantCrudHandler) Put(r *http.Request) resputl.SrvcRes {
	...
	f := dbrepository.Factory{}
	userObj := f.NewUser(requestdata.Name, requestdata.Address, requestdata.AddressLine2, requestdata.URL, requestdata.Outcode, requestdata.Postcode, requestdata.Rating, requestdata.TypeOfFood)
	err = p.mongoSession.Update(userObj, usID)
	if err != nil {
		//logger.Fatalf("Error while creating in DB: %v", err)
		return resputl.ProcessError(restauranterrors.UnprocessableEntityError("Error in writing to DB"), "")
	}
